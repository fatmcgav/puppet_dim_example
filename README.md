...
>     \# /Users/gavinw/.rvm/gems/ruby-1.9.3-p551@dim_test/gems/puppet-3.7.5/lib/puppet/util.rb:166:in `benchmark'
...
>     \# ./spec/classes/profile_module_spec.rb:6:in `block (2 levels) in <top (required)>'

>Finished in 0.06839 seconds (files took 0.64398 seconds to load)
1 example, 1 failure
